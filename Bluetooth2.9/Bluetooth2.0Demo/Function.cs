...
namespace Bluetooth2._0Demo
{
    class Function
    {
        ...
        public static string TimeCycle(int second)
        {
        ...
        /// <param name="BT_ID">判断是否要隐藏学号信息</param>
        public static ObservableCollection<Student> DisplayContent(ObservableCollection<Student> allStuInfo, int displayContent, int rank, bool BT_ID)
        {
